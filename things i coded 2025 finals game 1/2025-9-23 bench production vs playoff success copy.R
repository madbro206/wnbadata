...
kable(team_avg_starter_pct %>%select(team_name, season, avg_pct_starter_points, made_playoffs) %>%head(15), digits = 1, col.names = c("Team", "Season","Starter %","Made Playoffs?"))
